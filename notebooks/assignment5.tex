...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, breakable, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, colframe=quarto-callout-important-color-frame, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important note}, arc=.35mm, leftrule=.75mm, left=2mm, colback=white, opacitybacktitle=0.6, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, breakable, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important note}, arc=.35mm, leftrule=.75mm, left=2mm, colback=white, opacitybacktitle=0.6, coltitle=black]
