...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important note}, bottomrule=.15mm, colback=white, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, arc=.35mm, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, left=2mm, leftrule=.75mm, rightrule=.15mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Important note}, bottomrule=.15mm, colback=white, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, arc=.35mm, titlerule=0mm, opacitybacktitle=0.6, toptitle=1mm, left=2mm, leftrule=.75mm, rightrule=.15mm, opacityback=0]
