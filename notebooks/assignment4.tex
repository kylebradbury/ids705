...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, bottomrule=.15mm, left=2mm, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, titlerule=0mm, toptitle=1mm, colframe=quarto-callout-important-color-frame, opacityback=0, rightrule=.15mm, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, toprule=.15mm, coltitle=black, arc=.35mm, opacitybacktitle=0.6]
