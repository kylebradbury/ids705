...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, leftrule=.75mm, colframe=quarto-callout-important-color-frame, toptitle=1mm, opacityback=0, opacitybacktitle=0.6, titlerule=0mm, bottomtitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, left=2mm, colback=white, coltitle=black, toprule=.15mm, breakable, arc=.35mm, bottomrule=.15mm, colbacktitle=quarto-callout-important-color!10!white]
