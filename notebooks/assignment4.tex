...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, colframe=quarto-callout-important-color-frame, rightrule=.15mm, arc=.35mm, toprule=.15mm, titlerule=0mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, breakable, coltitle=black, opacitybacktitle=0.6, opacityback=0, bottomrule=.15mm, toptitle=1mm, colback=white, bottomtitle=1mm, leftrule=.75mm]
