...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, colframe=quarto-callout-important-color-frame, toprule=.15mm, breakable, colback=white, leftrule=.75mm, toptitle=1mm, left=2mm, arc=.35mm, opacitybacktitle=0.6, bottomrule=.15mm, coltitle=black, bottomtitle=1mm, opacityback=0, rightrule=.15mm, titlerule=0mm]
