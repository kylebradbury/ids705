...
\begin{tcolorbox}[enhanced jigsaw, breakable, left=2mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important Note}, toptitle=1mm, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, rightrule=.15mm, titlerule=0mm, arc=.35mm, colback=white, opacitybacktitle=0.6, toprule=.15mm, leftrule=.75mm, bottomrule=.15mm]
