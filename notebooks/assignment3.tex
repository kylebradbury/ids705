...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, leftrule=.75mm, coltitle=black, colframe=quarto-callout-note-color-frame, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, left=2mm, bottomrule=.15mm, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, opacityback=0, breakable, colback=white]
