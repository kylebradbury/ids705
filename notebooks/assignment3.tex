...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, leftrule=.75mm, toprule=.15mm, arc=.35mm, opacityback=0, opacitybacktitle=0.6, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, breakable, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, left=2mm]
