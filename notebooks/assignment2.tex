...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toptitle=1mm, bottomtitle=1mm, toprule=.15mm, opacityback=0, colback=white, titlerule=0mm, breakable, colbacktitle=quarto-callout-note-color!10!white, arc=.35mm, left=2mm, bottomrule=.15mm, coltitle=black, leftrule=.75mm, rightrule=.15mm]
