...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, arc=.35mm, colback=white, bottomtitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, breakable, toptitle=1mm, bottomrule=.15mm, coltitle=black, titlerule=0mm, left=2mm, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6]
