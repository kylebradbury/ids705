...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, rightrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, opacityback=0, opacitybacktitle=0.6, left=2mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, toprule=.15mm, breakable, bottomrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, arc=.35mm, coltitle=black]
