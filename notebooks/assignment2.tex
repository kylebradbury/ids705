...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colback=white, toprule=.15mm, arc=.35mm, coltitle=black, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, breakable, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, leftrule=.75mm, opacityback=0]
