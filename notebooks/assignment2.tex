...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacityback=0, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, coltitle=black, leftrule=.75mm, titlerule=0mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, bottomtitle=1mm, arc=.35mm, rightrule=.15mm]
