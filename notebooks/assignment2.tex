...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, rightrule=.15mm, coltitle=black, left=2mm, arc=.35mm, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, colback=white, toprule=.15mm, colframe=quarto-callout-note-color-frame, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, titlerule=0mm, bottomtitle=1mm, leftrule=.75mm, bottomrule=.15mm]
