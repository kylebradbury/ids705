...
### Grading:
- 50% Assignments (5 required, each worth 10%)
- 20% Quizzes (~20 required, each worth ~1%)
- 15% In-class Exam
- 15% Final Project
...
### Sick absences
To keep the university community as safe and healthy as possible, please do not come to class if you have cold symptoms. Please inform the instructor of your absence and plan to complete any missed work. Students who encounter short- and long-term medical issues or instances of personal distress or emergency can seek academic support if needed. *Recordings of the class will be available for excused absences*.
...
- Course **projects deliverables** will not be accepted after the deadline and a grade of 0 will be assigned. 
- Late **assignment** submissions will result in a reduction of 5 points off the grade per day late. 
- **Quizzes** will not be accepted after the deadline since the answers to the quizzes are discussed in and made available after the class in which they're due. Quizzes are typically posted a week or more in advance, so you are encouraged to start early (you can submit as early as you'd like). Quizzes cannot be made up since we typically go over the quiz answers immediately after in class.
...
- Mode 2: Individual Assignment – Some collaboration is permitted. Students hand in *individual* work, but they may work with others (at the level of ideas rather than implementation) if they provide citations of the help they received, such as a list of people who assisted/collaborated with them to produce the final product. Duplication or copying is **never** permissible, even in part, and constitutes a breach of the honor code. This means that all work should in assignments should be your own. **Applies to Assignments**
